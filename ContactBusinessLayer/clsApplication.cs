...
namespace ContactBusinessLayer
{
    public class clsApplication
    {
        ...
        public string ApplicantFullName
        {
            get
            {
                return clsPerson.GetPersonByID(ApplicantPersonID).FirstName;
            }
        }
        public DateTime ApplicationDate { set; get; }
        public int ApplicationTypeID { set; get; }
        public clsApplicationTypres ApplicationTypeInfo;
...

        {
            ...
            this.ApplicationTypeInfo = clsApplicationTypres.GetApplicationByID(ApplicationTypeID);
